...
public class JwtAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    public JwtAuthorizationFilter(AuthenticationManager authenticationManager, UserFacadeService userService) {
    ...
    private Authentication getUsernamePasswordAuthentication(HttpServletRequest request) {
        ...
        if (token != null) {
            ...
            if (userName != null) {
                UserFacade user = userService.findUserByName(userName);
